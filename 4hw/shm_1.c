...
int main()
{
	...
	/* Binary semaphore with value 0 */
	if ((mutex_sem1 = sem_open(SEM_MUTEX_NAME_1, O_CREAT, 0660, 0)) == SEM_FAILED)
		exit(1);

	if ((mutex_sem2 = sem_open(SEM_MUTEX_NAME_2, O_CREAT, 0660, 0)) == SEM_FAILED)
		exit(1);
